...
parser.add_argument('--task', type=str, choices=['ioi', 'docstring', 'induction', 'tracr-reverse', 'tracr-proportion', 'greaterthan', 'or_gate'], 
                    help='Choose a task from the available options: ioi, docstring, induction, tracr-reverse, tracr-proportion, greaterthan', default='or_gate')
parser.add_argument('--zero-ablation', action='store_true', help='Use zero ablation')
parser.add_argument('--wandb-entity', type=str, required=False, default=None, help='Value for WANDB_ENTITY_NAME')
...
parser.add_argument("--wandb-dir", type=str, default="/autodl-tmp/wandb")
