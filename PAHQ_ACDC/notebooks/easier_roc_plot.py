...
#
import sys 
sys.path.append("/root/autodl-tmp/acdc")
import plotly
import os
import numpy as np
import json
...
DATA_DIR = Path("../experiments") /"results" / "plots_data"
all_data = {}
...
for i, alg in enumerate(["ACDC", "SP"]):
    this_data = all_data["trained"]["random_ablation"]["docstring"]["kl_div"][alg]
...
#fig.show()
output_path = "roc_curves_and_heatmap_ioi.png"  # 保存文件的路径
