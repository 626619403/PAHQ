...
'''USE THIS TO REPLACE FILE *********************YOUR ENVIRONMENT***************/lib/python3.10/site-packages/cmapy.py
IF YOU DON'T, THIS WILL HAVE CONFLICT WITH MATPLOTLIB>=3.4 because this library has stopped maintenance.'''
...
def cmap(cmap_name, rgb_order=False):
    ...
    c_map = matplotlib.pyplot.get_cmap(cmap_name, 256)
...
def colorize(image, cmap_name, rgb_order=False):
